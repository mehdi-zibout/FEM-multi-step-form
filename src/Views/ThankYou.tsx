const ThankYou = () => {
  return (
    <div className="flex flex-col justify-center items-center text-center h-full tablet:w-[28.125rem] tablet:ml-3">
      <svg
        xmlns="http://www.w3.org/2000/svg"
        className="w-[56px] h-[56px] tablet:w-[80px] tablet:h-[80px]"
        viewBox="0 0 80 80"
      >
        <g fill="none">
      ...
      <h1 className="text-xl text-[1.5rem] text-denim pt-6 pb-2">Thank you!</h1>
      <p className="text-grey text-l">
